...
layers configuration. You are free to put any user code."
    ...
    (setq-default dotspacemacs-configuration-layers 
      '(auto-completion :variables
			 ...
			 auto-completion-complete-key-behavior nil
			 auto-completion-private-snippets-directory nil
			 auto-completion-enable-help-tooltip t
			 auto-completion-enable-sort-by-usage t
			 auto-completion-enable-snappets-in-popup t
                        ))
  ...
  (evil-leader/set-key "o p" 'paste-from-clipboard)
    ...
    (xterm-mouse-mode -1)
     ;;For py-yapf--------------------------------
    (add-to-list 'load-path "/home/kevin/.emacs.d/layers/+lang/python/local/py-yapf/")
    (require 'py-yapf)
    (add-hook 'python-mode-hook 'py-yapf-enable-on-save)
    (setq-default dotspacemacs-configuration-layers '(
	(python :variables python-enable-yapf-format-on-save t)))
    ;;For pylookup-------------------------------
    ;;(setq pylookup-dir "/home/kevin/.emacs.d/layers/+lang/python/local/pylookup/")
...
(custom-set-variables
 ...
 '(pyim-dicts
   (quote
    ((:name "computer" :file "/home/kevin/Downloads/scel2pyim-master/computer.pyim" :coding utf-8-unix :dict-type pinyin-dict)
     (:name "iphone.yim" :file "/home/kevin/Downloads/scel2pyim-master/iphone.pyim" :coding utf-8-unix :dict-type pinyin-dict)
     (:name "BigDict-01" :file "/home/kevin/.emacs.d/.cache/pyim-bigdict.pyim" :coding utf-8-unix :dict-type pinyin-dict)))))
(custom-set-faces
